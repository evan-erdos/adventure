...
namespace PathwaysEngine.Inventory {
    ...
    public class Gun : Weapon {
        ...
        public float
            ...
            spreadEndemic = 0.1f, spreadAimed = 0.1f,
            spreadMax = 0.1f, spreadJam = 1f,
            timeShot = 0.05f, sinceShot = 0f,
            timeReload = 2f, sinceReload = 0f,
            forceShot = 443f, damageShot = 1024f,
            deltaShot = 256f;
        public string MunitionType = "9mm PARA";
        public string[] animNames, animFire, animReload;
        public enum WeaponTypes : byte {
            Projectile, Trajectile, Crystal, Melee };
        ...
        // Default, Attack, Shell, Stowed, Focus, Crossed
        ...
        void Update() {
            ...
            if (sinceReload<timeReload)
                sinceReload+=Time.deltaTime;
